...
from .views import CityPostDelete, Home, About, PostCreate, PostDetail, ProfileDetail, ProfileUpdate, ProfileRedirect, CityDetail, CityPostRedirect, PostCreate, PostUpdate
...
urlpatterns = [
    ...
    path('cities/<int:pk>/post/new/', PostCreate.as_view(), name="post_new"),
    path('cities/<int:city_pk>/post/<int:pk>/update/',
